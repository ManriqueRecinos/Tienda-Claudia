<?php
// Vista Index con sidebar y botón de cerrar sesión
...
<div class="min-h-screen flex bg-gray-100">
  ...
  <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex md:flex-col">
    ...
    <div class="p-4 border-t">
      <button type="button" data-action="logout" class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
  ...
  <main class="flex-1">
    ...
    <div class="h-16 bg-white border-b flex items-center justify-between px-4">
      ...
      <div class="flex items-center space-x-3">
        ...
        <button type="button" data-action="logout" class="inline-flex items-center px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700">
    ...
    <div class="p-6">
      <div class="bg-white rounded shadow p-6">
        ...
        <p class="text-gray-600 mt-2">Esta es una página de inicio básica con un sidebar y botón de cerrar sesión. Personalízala a tu gusto.</p>
      </div>
    </div>
  </main>
</div>
