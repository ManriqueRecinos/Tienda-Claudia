    ...
    <div class="relative z-10 min-h-full flex items-center justify-center p-4">
      <div class="w-full max-w-lg bg-white rounded-lg shadow-lg">
        <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
          ...
          <button type="button" id="modal-usuario-close" class="text-gray-500 hover:text-gray-700">
        ...
        <form id="form-usuario" class="p-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input id="form-usuario-username" name="usuario" type="text" class="w-full border rounded px-3 py-2 text-sm" />
            </div>
            <div>
              <label for="form-usuario-nombres" class="block text-xs text-gray-600 mb-1">Nombres</label>
              <input id="form-usuario-nombres" name="nombres" type="text" class="w-full border rounded px-3 py-2 text-sm" />
            </div>
            <div>
              <label for="form-usuario-apellidos" class="block text-xs text-gray-600 mb-1">Apellidos</label>
              <input id="form-usuario-apellidos" name="apellidos" type="text" class="w-full border rounded px-3 py-2 text-sm" />
            </div>
            
            <div>
              <label for="form-usuario-rol" class="block text-xs text-gray-600 mb-1">Rol</label>
              <select id="form-usuario-rol" name="id_rol" class="w-full border rounded px-3 py-2 text-sm">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="relative">
                <input id="form-usuario-pass" name="contrasenia" type="password" class="w-full border rounded px-3 py-2 pr-10 text-sm" placeholder="Dejar vacío para no cambiar" />
